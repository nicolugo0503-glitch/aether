          ...
          html: `
            <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px;background:#09090b;color:#fff;border-radius:12px">
              ...
              <table style="width:100%;border-collapse:collapse">
                <tr><td style="padding:8px 0;color:#a1a1aa;width:80px">Name</td><td style="padding:8px 0;color:#fff;font-weight:600">${name}</td></tr>
                <tr><td style="padding:8px 0;color:#a1a1aa">Email</td><td style="padding:8px 0"><a href="mailto:${email}" style="color:#a78bfa">${email}</a></td></tr>
                <tr><td style="padding:8px 0;color:#a1a1aa">Subject</td><td style="padding:8px 0;color:#fff">${subject || "(none)"}</td></tr>
              </table>
