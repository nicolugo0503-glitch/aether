  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <p className="text-sm text-muted mt-1">Your username appears in the dashboard and on your account.</p>
        <form action={updateProfile} className="mt-4 space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-muted mt-1">This is how you appear across the platform.</p>
          </div>
          <button className="btn-secondary">Save Username</button>
        </form>
      </div>
