    ...
    <div className="relative bg-black overflow-x-hidden">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 flex items-center justify-between px-6 py-4 md:px-12"
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-bold text-white text-lg tracking-tight">Aether</span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/signup"
            className="group relative inline-flex items-center gap-2 px-4 py-2 rounded-xl text-white text-sm font-semibold overflow-hidden btn-shine"
      ...
      <section id="agents" className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white mb-6">Meet your<br /><span className="gradient-text">new team.</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={agent.name}
                className="rounded-3xl p-6 flex flex-col transition-all duration-300 group cursor-pointer"
                style={{
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={step.n}
                className="flex gap-6 rounded-3xl p-8 transition-all duration-300 hover:scale-[1.005]"
                style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div className="shrink-0 h-16 w-16 rounded-2xl flex items-center justify-center font-black text-lg"
      ...
      <section id="pricing" className="py-32">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-black gradient-text mb-4">Pricing that scales with you.</h2>
            <p className="text-zinc-500 text-lg">Start free. Upgrade when the ROI is obvious.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "Free", price: "$0", desc: "Try before you commit", features: ["1 AI employee","25 runs/month","Email campaigns","Dashboard analytics"], highlight: false },
              { name: "Starter", price: "$49", desc: "For growing teams", features: ["3 AI employees","500 runs/month","Email campaigns","Instagram + Facebook + X","Google Sheets import","Web search enabled","Priority support"], highlight: true },
              { name: "Scale", price: "$1,499", desc: "For serious operators", features: ["100 AI employees","50,000 runs/month","Everything in Starter","Custom agent builder","API access","Dedicated support","SLA guarantee"], highlight: false },
            ].map((plan) => (
              <div key={plan.name}
                ...
                {plan.highlight && (
                  <>
                    ...
                    <div className="absolute top-4 right-4 text-xs text-violet-300 bg-violet-500/10 border border-violet-500/30 rounded-full px-3 py-1">
                      Most popular
                    </div>
                  </>
                )}
      ...
      <footer className="border-t border-white/[0.04] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-10 mb-16">
            <div className="md:col-span-2">
              <Link href="/" className="flex items-center gap-2.5 mb-4">
                <div className="h-9 w-9 rounded-xl flex items-center justify-center font-black text-white"
                  style={{ background: "linear-gradient(135deg, #7c3aed, #6d28d9)", boxShadow: "0 0 20px rgba(124,58,237,0.4)" }}>A</div>
                <span className="font-bold text-white text-lg">Aether</span>
              </Link>
            ...
            {[
              { title: "Product", links: ["Features","AI Agents","Campaigns","Social Media (incl. X)","Pricing"] },
              ...
              <div key={col.title}>
                ...
                <ul className="space-y-3">
                  {col.links.map(l => (
                    <li key={l}><Link href="#" className="text-zinc-600 hover:text-zinc-300 text-sm transition-colors">{l}</Link></li>
                  ))}
                </ul>
              </div>
            ))}
          ...
          <div className="border-t border-white/[0.04] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-zinc-700 text-sm">© 2025 Aether Inc. All rights reserved.</p>
