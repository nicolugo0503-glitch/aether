...
import {
  ...
  Star, Send, ChevronRight, HelpCircle,
} from "lucide-react";
...
const MORE_ITEMS = [
  ...
  { href: "/dashboard/help",       label: "Help",       desc: "Chat support & FAQ",        icon: HelpCircle, color: "#0ea5e9", bg: "rgba(14,165,233,0.15)"  },
];
        ...
        >
          ...
          >
            ...
            <div style={{
              overflowY: "auto",
              flex: 1,
              paddingBottom: "calc(env(safe-area-inset-bottom, 12px) + 80px)",
            }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{
                          width: 40, height: 40,
                          borderRadius: 12,
                          background: active ? "rgba(124,58,237,0.2)" : item.bg,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          flexShrink: 0,
                          ...
                          <Icon
                            size={18}
                            color={active ? "#a78bfa" : item.color}
                            strokeWidth={2}
                          />
                        </div>
              ...
              <div style={{ padding: "0 16px 8px" }}>
                <div style={{
                  ...
                  {fbStage === "done" ? (
                    <div style={{ textAlign: "center", padding: "12px 0", color: "#22c55e", fontSize: 14, fontWeight: 600 }}>
